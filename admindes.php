    ...
    <div class="container">
        ...
        <div class="col-12">
            <div class="btn_adminusu">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalUsu">Agregar destino</button>
            </div>
        </div>
        <!-- Modal -->
                    ...
                    <div class="formulario">
                        <form action="nuevo.php" method="POST">
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" name="nom_des" placeholder="Escribe el nombre del destino aqui" required>
                            </div>
                            <br>
                            <br>
                            <div class="d-flex justify-content-center" id="btnmodalusu">
                                <button type="submit" class="btn btn-primary" name="insertar_des">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="col-12">
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    <tr>
                        <th scope="row"><?php echo $row['id_d'] ?></th>
