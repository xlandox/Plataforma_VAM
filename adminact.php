    ...
    <div class="container">
        ...
        <div class="col-12">
            <div class="btn_adminusu">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalUsu">Agregar actividad</button>
            </div>
        </div>
        <!-- Modal -->
                    ...
                    <div class="formulario">
                        <form action="nuevo.php" method="POST">
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" name="nombre" placeholder="Nombre la actividad" required>
                            </div>
                            <br>
                            <div class="input-group flex-nowrap">
                                <div class="input-group-prepend">
                            ...
                            <div class="d-flex justify-content-center" id="btnmodalusu">
                                <button type="submit" class="btn btn-primary" name="insertar_act">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="col-12">
            <table class="table table-striped table-dark">
                ...
                <?php
                    $query="SELECT*FROM tbl_actividades";
                    $consulta=sqlsrv_query($conn,$query);
                    while ($row=sqlsrv_fetch_array($consulta, SQLSRV_FETCH_ASSOC)) {
                ?>
                <tbody>
                    <tr>
                        <th scope="row"><?php echo $row['id_a'] ?></th>
